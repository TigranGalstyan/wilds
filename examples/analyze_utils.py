...
def all_logistics(z, c, y, epoch, sample=1, validation=True, include_test=False):
    ...
    for c in range(y['train'].shape[-1]):
        ...
        if include_test:
            ...
            c_perclass_test[c] = logistic_reg_accuracy(train_test_z_class, train_test_c_class, sample=sample, validation=validation)
